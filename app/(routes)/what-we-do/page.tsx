            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative hidden lg:block">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-white/5 border border-white/10">
                  <img loading="lazy" src="/images/placeholder.png" alt="What We Do" className="w-full h-full object-cover opacity-60" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {currentServices.map((service) => (
                <div key={service.href} className="group border border-gray-100 rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
