        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {subtitle && (
                <p className="text-[#9DEF06] font-bold text-lg">{subtitle}</p>
              )}
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {processSteps.map((step, i) => (
              <div key={i} className="bg-[#00286D] text-white rounded-2xl p-6 relative overflow-hidden group hover:bg-[#001a4a] transition-all duration-300">
