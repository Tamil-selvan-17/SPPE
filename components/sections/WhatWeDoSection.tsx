    ...
    <section className="py-20 px-4 md:px-8 lg:px-20 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          {/* Sidebar */}
          <FadeIn direction="left" delay={0} className="lg:w-80 flex-shrink-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {currentServices.map((service) => (
                <Link
                  key={service.href}
                  href={service.href}
                  className="group flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-[#00286D] hover:shadow-md transition-all duration-300"
                >
