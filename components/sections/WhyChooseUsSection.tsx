...
const reasons = [
  {
    ...
    description:
      "With 10+ years in the industry, we deliver reliable electrical solutions backed by proven expertise.",
  },
  {
    icon: Shield,
    title: "EA Grade Licensed Contractors",
    description:
      "Certified EA Grade contractors ensuring full compliance, safety, and professional accountability.",
  },
  {
    icon: Zap,
    title: "Installation, Testing & Commissioning Experts",
    description:
      "Complete electrical installation with thorough testing and commissioning for optimal performance.",
  },
  {
    icon: CheckCircle,
    title: "Quality & Safety Focused",
    description:
      "Committed to strict quality standards and safety practices for dependable, compliant results.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((reason, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white/10 border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group"
              >
